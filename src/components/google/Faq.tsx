...
const faqs = [
  {
    ...
    a: "You’ll receive an email and WhatsApp message with the Zoom links, workshop schedule, and the private community access details.",
  },
  {
    q: "Are the sessions live or recorded?",
    a: "The 2-day workshop is live on Zoom. Recordings may be provided at the organizer’s discretion for a limited time.",
  },
  {
